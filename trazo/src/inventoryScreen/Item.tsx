...
const ItemModal: React.FC<ItemProps> = ({ onClose, seeds, products,misc }) => {
            ...
            <div className="modal-content bg-white w-1/2 h-full shadow-lg relative flex flex-none flex-col rounded-md gap-4">
                ...
                {seeds && <form onSubmit={handleSubmit} className='flex flex-col gap-4 p-5 justify-between h-full'>
                    <label htmlFor="supplierName" className='flex flex-row gap-2 items-center justify-between'>Supplier Name
                        <input disabled={!edit} type="text" id="supplierName" name="supplierName" className='bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 w-3/4 block p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500' placeholder='' />
                    </label>
                    <label htmlFor="seedVariety" className='flex flex-row gap-2 items-center justify-between'>Seed Variety
                        <input disabled={!edit} type="text" id="seedVariety" name="seedVariety" className='bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 w-3/4 block p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500' placeholder='' />
                    </label>
                    <label htmlFor="dateOfAcquisition" className='flex flex-row gap-2 items-center justify-between'>Date of Acquisition
                        <input disabled={!edit} type="date" id="dateOfAcquisition" name="dateOfAcquisition" className='bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 w-3/4 block p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500' />
                    </label>
                    <label htmlFor="quantity" className='flex flex-row gap-2 items-center justify-between'>Quantity
                        <input disabled={!edit} type="number" id="quantity" name="quantity" className='bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 w-3/4 block p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500' />
                    </label>
                    <label htmlFor="id" className='flex flex-row gap-2 items-center justify-between'>ID
                        <input disabled={!edit} type="text" id="id" name="id" className='bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 w-3/4 block p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500' />
                    </label>
                    <div className="flex flex-row gap-2">
                        <button style={!edit ? { display: 'none' } : { display: 'block' }} type="submit" className=' bg-green-800 p-2 px-4 text-white rounded-md w-min items-center self-center'>Submit</button>
                ...
                {products && <form onSubmit={handleSubmit} className='flex flex-col gap-4 p-5 h-full justify-between'>
                    <label htmlFor="productId" className='flex flex-row gap-2 items-center justify-between'>Product ID
                        <select disabled={!edit} id="productId" name="productId" className='bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 w-3/4 block p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500'>
                    ...
                    <label htmlFor="productType" className='flex flex-row gap-2 items-center justify-between'>Product Type
                        <div className='flex flex-row gap-2'>
                            <input disabled={!edit} type="radio" id="refrigerated" name="productType" value="refrigerated" onChange={() => setPowder(false)} />
                            <label htmlFor="refrigerated">Refrigerated</label>
                        </div>
                        <div className='flex flex-row gap-2'>
                            <input disabled={!edit} type="radio" id="powder" name="productType" value="powder" onChange={() => setPowder(true)} />
                    ...
                    <label htmlFor="productQuantity" className='flex flex-row gap-2 items-center justify-between'>Quantity
                        <input disabled={!edit} type="number" id="productQuantity" name="productQuantity" className='bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 w-3/4 block p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500' />
                    </label>
                    {!powder && <label htmlFor="packageSize" className='flex flex-row gap-2 items-center justify-between'>Package Size
                        <select disabled={!edit} id="packageSize" name="packageSize" className='bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 w-3/4 block p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500'>
                ...
                {misc && <form onSubmit={handleSubmit} className='flex flex-col gap-4 h-full justify-between p-5'>
                    <label htmlFor="miscProduct" className='flex flex-row gap-2 items-center justify-between'>Misc Product
                        <label htmlFor='miscFertilizer' className='flex flex-row gap-2'>
                            <input disabled={!edit} type='radio' id='miscFertilizer' name='miscProduct' value='Fertilizer' />Fertilizer
                            </label>
                        <label htmlFor='miscSoil' className='flex flex-row gap-2'><input disabled={!edit} type='radio' id='miscSoil' name='miscProduct' value='Soil' />Soil</label>
                        <label htmlFor='PackingMaterial' className='flex flex-row gap-2'><input disabled={!edit} type='radio' id='miscPackingMaterial' name='miscProduct' value='PackingMaterial' />Packing Material</label>
                    </label>
                    <label htmlFor="miscSupplier" className='flex flex-row gap-2 items-center justify-between'>Supplier
                        <input disabled={!edit} type="text" id="miscSupplier" name="miscSupplier" className='bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 w-3/4 block p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500' />
                    </label>
                    <label htmlFor="miscQuantity" className='flex flex-row gap-2 items-center justify-between'>Quantity
                        <input disabled={!edit} type="number" id="miscQuantity" name="miscQuantity" className='bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 w-3/4 block p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500' />
                    </label>
                    <label htmlFor="miscDescription" className='flex flex-row gap-2 items-center justify-between'>Description
                        <textarea disabled={!edit} id="miscDescription" name="miscDescription" className='bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 w-3/4 block p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500' />
                    </label>
